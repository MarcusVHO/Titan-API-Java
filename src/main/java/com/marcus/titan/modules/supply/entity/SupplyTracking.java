...
public class SupplyTracking {
    ...
    public void refund() throws Exception {
        if (getSupplyAt == null && suppliedAt == null){
            claimedAt = null;
        } else {
            throw new Exception();
        }
    ...
    public void startRefueling(Integer operatorId) {
        this.getSupplyAt =  Instant.now();
        this.suppliedBy = operatorId;
    }

    public void endRefueling() {
        suppliedAt = Instant.now();
    }
